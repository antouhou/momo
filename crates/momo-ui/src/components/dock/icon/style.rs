...
pub(in crate::components::dock) const DOCK_BUTTON_SIZE: f32 = 72.0;
const DOCK_BUTTON_RADIUS: f32 = 16.0;
pub(in crate::components::dock) const DOCK_ICON_SIZE: f32 = 52.0;
pub(in crate::components::dock) const DOCK_ICON_GLYPH_SIZE: usize = 52;

pub(in crate::components::dock) fn hidden_dock_button_style() -> Style {
    Style::new()
        .with_fixed_size(DOCK_BUTTON_SIZE, DOCK_BUTTON_SIZE)
        .with_background_color(Color::TRANSPARENT)
}

pub(in crate::components::dock) fn dock_button_style(
