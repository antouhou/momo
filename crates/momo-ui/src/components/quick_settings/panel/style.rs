use super::super::style::{
    PANEL_RADIUS, SETTINGS_MENU_CONTENT_WIDTH, SETTINGS_MENU_GAP, SETTINGS_MENU_HORIZONTAL_PADDING,
    SETTINGS_MENU_VERTICAL_PADDING, SETTINGS_MENU_WIDTH, SETTINGS_PANEL_BORDER_WIDTH,
